...
One way to make quick interactive phylogenetic tree is using `r Biocpkg("ggtree")` with the `r CRANpkg("plotly")` package. The `r Biocpkg("ggtree")` package also supports interactive manipulation of phylogenetic tree via the [identify()](#identify) method.
...
## comicR: comic (xkcd-like) phylogenetic tree {#commicR}
...
## data.tree: print ASCII-art rooted tree {#ascii-tree}
