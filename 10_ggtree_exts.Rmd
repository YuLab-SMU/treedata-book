...
p <- p +
     ...
     theme(
         legend.title=element_text(size=20), # The title of legend 
         legend.text=element_text(size=15) # The label text of legend, the sizes should be adjust with dpi.
     )
p
```
...
cladelabels <- mapply(function(x, y, z){geom_cladelabel(node=x, label=y, barsize=NA, extend=0,
                                                    offset.text=z, fontsize=10, angle="auto",
...
```{r, fig.width=7, fig.height=7, fig.align="center", warning=FALSE, message=FALSE, fig.cap="(ref:Cauricap)", fig.scap="(ref:Cauriscap)", dpi=300, out.extra='', warning=FALSE, Caurisplot}
library(ggtree)
library(ggtreeExtra)
library(ggplot2)
library(ggnewscale)
...
p3 <- p2 +
      ...
      theme(
          legend.background=element_rect(fill=NA),
          legend.title=element_text(size=40), # The size should be adjusted with different devout.
          legend.text=element_text(size=30),
          legend.spacing.y = unit(0.02, "cm")
      )
p3
...
```{r, fig.width=7, fig.height=7, fig.align="center", warning=FALSE, message=FALSE, fig.cap="(ref:Styphicap)", fig.scap="(ref:Styphiscap)", dpi=300, out.extra='', warning=FALSE, Styphiplot}
library(ggtreeExtra)
library(ggtree)
library(ggplot2)
library(ggnewscale)
...
p3 <-p2 +
     ...
     theme(
           legend.title=element_text(size=40), # The size should be adjusted with the different devout.
           legend.text=element_text(size=30),
           legend.spacing.y = unit(0.02, "cm")
           )
p3
