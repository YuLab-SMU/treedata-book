...
```{r frogimage, fig.width=8.5, fig.height=7, message=F, warning=F, dev='png', dpi=200, fig.cap="(ref:frogimagecap)", fig.scap="(ref:frogimagescap)", out.width='100%'}
library(ggimage)
library(ggtree)
...
```{r barInset, fig.width=10, fig.height=9.6, fig.process=svg2png, fig.cap="(ref:barInsetcap)", fig.scap="(ref:barInsetscap)", out.width='100%'}
library(phytools)
data(anoletree)
...
```{r pieInset, fig.width=10, fig.height=9.6, fig.process=svg2png, fig.cap="(ref:pieInsetcap)", fig.scap="(ref:pieInsetscap)", out.width='100%'}
...
```{r barpieInset, fig.width=10, fig.height=9.6, fig.process=svg2png, fig.cap="(ref:barpieInsetcap)", fig.scap="(ref:barpieInsetscap)", out.width='100%'}
pies_and_bars <- pies
...
```{r emojifan, fig.width=9.2, fig.height=7.3, fig.process=svg2png, warning=F, echo=F, dev='svg', fig.cap="(ref:emojifancap)", fig.scap="(ref:emojifanscap)", out.width='100%'}
p <- ggtree(tree, layout = "circular", size=1) +  
  geom_tiplab(parse="emoji", size=10, vjust=.25)
