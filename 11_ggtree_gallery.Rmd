...
(ref:bpintervalcap) **Partitioning bootstrap values**. Bootstrap values were divided to three categories and this information was used to color circle points.
