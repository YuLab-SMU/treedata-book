...
This example reproduce Figure 1 of [@larsen_identification_2019]. It used `groupOTU` to add grouping information of chicken CTLDcps. The branch linetype and color are defined based on this grouping information. Two groups of CTLDcps are highlighted in different background colors (red for Group II and green for Group V). The avian-specific expansion of group V with subgroup of A and B- are labelled (Figure \@ref(fig:treeLarsen)).
