...
## prevent calling igraph::parent
parent <- tidytree::parent

## prevent calling phylobase::ancestor
ancestor <- tidytree::ancestor

## prevent calling OutbreakTools::get.data
get.data <- tidytree::get.data
