...
```{r rotategif, eval=knitr::is_latex_output(), echo=knitr::is_latex_output(), fig.width=15, fig.height=6}
set.seed(2016-05-29)
x <- rtree(50)
p <- ggtree(x) + geom_tiplab()
...
```{r fangif, eval=knitr::is_latex_output(), echo=knitr::is_latex_output(), fig.width=8, fig.height=8, message=FALSE}
set.seed(123)
tr <- rtree(50)
...
```{r eval=knitr::is_latex_output(), echo=knitr::is_latex_output(), fig.width=8, fig.height=8, message=FALSE}
