...
A phylogenetic tree can be annotated by mapping different line types, sizes, colors. or shape the branches or nodes that have been assigned to different groups. 
