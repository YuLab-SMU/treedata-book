...
Once it was installed, loading the package will load the core `r pkg_treedataverse` packages, including `r CRANpkg("tidytree")`, `r Biocpkg("treeio")`, `r Biocpkg("ggtree")`, and `r Biocpkg("ggtreeExtra")`.
