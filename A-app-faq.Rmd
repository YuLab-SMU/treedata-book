...
set.seed(123)
x <- rtree(10)
## binary choice of colours
d <- data.frame(node=1:Nnode2(x), colour = 'black')
d[c(2,3,14,15), 2] <- "red"

## multiple choice of line types
...
Users can use the `r CRANpkg("gginnards")` package to manipulate plot elements for more complicated scenario.
