...
library(ggbreak)
p2 <- p1 + scale_x_break(c(0.03, 0.09)) + hexpand(.05)
pg <- p1 + p + p2 + plot_annotation(tag_levels="A")
```
```{r outgroupEdge, fig.cap="(ref:outgroupEdgecap)", fig.scap="(ref:outgroupEdgescap)", fig.width=9, fig.height=5, out.width="100%", echo=FALSE}
print(pg)
```
