...
The third solution is using `hexpand()` as demonstrated in [session 10.5.2](#hexpand). 
...
```{r nwkbs, fig.width=12, fig.height=8, fig.cap="(ref:nwkbscap)", fig.scap="(ref:nwkbsscap)"}
...
```{r pointOnBranch, fig.cap="(ref:pointOnBranchcap)", fig.scap="(ref:pointOnBranchscap)", fig.width=8, fig.height=4.5}
set.seed(2020-05-20)
x <- rtree(10)
p <- ggtree(x)
