...
User can use [ggrepel](https://cran.r-project.org/web/packages/ggrepel/) package to repel overlapping text labels^[For details, please refer to <https://cran.r-project.org/web/packages/ggrepel/vignettes/ggrepel.html>].
.
...
## Editing tree graphic details {#export-edit}
