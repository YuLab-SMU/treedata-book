...
It also supports using name vector to set the widths of specific panels. The following code will display an identical figure to Figure \@ref(fig:facetWidth)A.
...
(ref:layer2cap) **Geometric layers that support subsetting.** Thes layers works with `ggplot2` (A) and `ggtree` (B).
