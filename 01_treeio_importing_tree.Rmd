...
To facilitate storing complex data associated with the phylogenetic tree, `r Biocpkg("treeio")`\index{treeio} implemented `write.baset` and `write.jtree` functions to export a `treedata` object into a single file (see [Chapter 3](#chapter3)). 
