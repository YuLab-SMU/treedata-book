...
To facilitate storing complex data associated with the phylogenetic tree, `r Biocpkg("treeio")`\index{treeio} implemented `write.beast` and `write.jtree` function to export treedata object into a single file (see [Chapter 3](#chapter3)). 
