...
geoms <- matrix(c(
  ...
  "geom_cladelab", "annotate a clade with bar and text label",
...
(ref:striplabelcap) **Labeling associated taxa.** `geom_cladelab` is for labeling Monophyletic and it also supports unrooted layout (A). `geom_strip` is designed for labeling associated taxa (Monophyletic, Polyphyletic or Paraphyletic) (B).
