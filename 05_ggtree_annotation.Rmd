...
```{r taxalink, fig.cap="(ref:taxalinkcap)", fig.scap="(ref:taxalinkscap)", fig.width=15, fig.height=5, warning=FALSE}
p1 <- ggtree(tree) + geom_tiplab() + geom_taxalink('A', 'E') + 
  geom_taxalink('F', 'K', color='red', linetype = 'dashed',
    arrow=grid::arrow(length=grid::unit(0.02, "npc")))

p2 <- ggtree(tree, layout="circular") + 
      geom_taxalink('A', 'E', color="grey", alpha=0.5, offset=0.05,
                    arrow=grid::arrow(length=grid::unit(0.01, "npc"))) + 
      geom_taxalink('F', 'K', color='red', linetype = 'dashed', alpha=0.5, offset=0.05,
                    arrow=grid::arrow(length=grid::unit(0.01, "npc"))) +
      geom_taxalink("L", "M", color="blue", alpha=0.5, offset=0.05,
                    hratio=0.8, arrow=grid::arrow(length=grid::unit(0.01, "npc"))) + 
      geom_tiplab()
...
p3 <- ggtree(tree, layout="circular") +
      geom_taxalink('A', 'E', color="grey", alpha=0.5, offset=-0.2, 
                    outward=FALSE,
                    arrow=grid::arrow(length=grid::unit(0.01, "npc"))) +
      geom_taxalink('F', 'K', color='red', linetype = 'dashed', alpha=0.5, offset=-0.2,
                    outward=FALSE,
                    arrow=grid::arrow(length=grid::unit(0.01, "npc"))) +
      geom_taxalink("L", "M", color="blue", alpha=0.5, offset=-0.2, 
                    outward=FALSE,
                    arrow=grid::arrow(length=grid::unit(0.01, "npc"))) +
      geom_tiplab(hjust=1) +
      scale_x_reverse(limit=c(150, 0))
