...
In addition, it also allow user to use the image or phylopic to annotate the clades.
...
(ref:cladelabaescap) **Labeling clades using aesthetic mapping.** geom_cladelab also allow users to use aesthetic mapping to annotate the clades (A). It also supports using image or phylopic to annotate clades (B). The character (such as color or size) of text or image can also be mapped (C).
