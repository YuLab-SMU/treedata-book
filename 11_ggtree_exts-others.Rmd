...
```{r, fig.width=7, fig.height=7, fig.align="center", message=FALSE, fig.cap="(ref:CRCdiffcap)", fig.scap="(ref:CRCdiffscap)", dpi=300, out.extra='', warning=FALSE, CRCdiffclade}
...
p <- ggdiffclade(obj=taxa,
     ...
     theme(panel.background=element_rect(fill=NA),
           ...
           legend.title=element_text(size=40), # This should be adjusted with different devout.
