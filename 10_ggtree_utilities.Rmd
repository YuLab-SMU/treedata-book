...
```{r ggComplexHeatmap, fig.cap="(ref:ggComplexHeatmapcap)", fig.scap="(ref:ggComplexHeatmapscap)", fig.width=11, fig.height=8}
library(cowplot)
library(tidyr)
library(ggplot2)
library(ggtree)
...
plot_grid(NULL, pc+xlim2(p), legend, NULL, 
          ph, p, g + ylim2(p), pp + ylim2(p), ncol=4, 
          rel_widths=c(.3, 1, .4, .4), rel_heights=c(.3, 1), align='hv')
```
